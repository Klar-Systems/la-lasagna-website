...
const c=spawn(CHROME,['--headless=new',`--remote-debugging-port=${PORT}`,'--window-size=390,2600','--no-first-run',`--user-data-dir=/tmp/cdp-gr-${PORT}`]);
...
const ids={image:'fe-block-yui_3_17_2_1_1764702229989_13421',heading:'fe-block-916612e5e07cbc8f0eba',phone:'fe-block-523cda3f8fca79c5cf2b'};
const e=`JSON.stringify((()=>{const o={};${Object.entries(ids).map(([k,v])=>`{const el=document.querySelector('.${v}');if(el)o['${k}']=getComputedStyle(el).gridRow;}`).join('')}return o;})())`;
